...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/image-ai-df8c
```

A live public deployment of this template is available at [https://image-ai-df8c.templates.workers.dev](https://image-ai-df8c.templates.workers.dev)
